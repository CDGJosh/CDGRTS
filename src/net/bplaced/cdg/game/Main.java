...
public class Main {
	...
	private void setupTextures() {
		texIds[0] = this.loadPNGTexture(LOCATION+"res\\textures\\grid.png", GL13.GL_TEXTURE0);
		texIds[1] = this.loadPNGTexture(LOCATION+"res\\textures\\obsidian.png", GL13.GL_TEXTURE0);
	...
	private void setupShaders() {		
		...
		vsId = this.loadShader(LOCATION+"res\\shader\\vertex.glsl", GL20.GL_VERTEX_SHADER);
		// Load the fragment shader
		fsId = this.loadShader(LOCATION+"res\\shader\\fragment.glsl", GL20.GL_FRAGMENT_SHADER);
